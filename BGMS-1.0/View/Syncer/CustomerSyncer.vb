Public Class CustomerSyncer
    ...
    Private Shared Sub loadAllRecordsByDate(ByRef dictionary As Dictionary(Of String, customer), ByVal connection As String)
    ...
    Private Shared Sub loadAllRecords(ByRef dictionary As Dictionary(Of String, customer),
