Public Class AgentSyncer
    ...
    Private Shared Sub loadAllRecordsByDate(ByRef dictionary As Dictionary(Of String, agent), ByVal connection As String)
    ...
    Private Shared Sub loadAllRecords(ByRef dictionary As Dictionary(Of String, agent),
