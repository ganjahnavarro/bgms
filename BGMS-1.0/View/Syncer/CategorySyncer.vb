Public Class CategorySyncer
    ...
    Private Shared Sub loadAllRecordsByDate(ByRef dictionary As Dictionary(Of String, category), ByVal connection As String)
    ...
    Private Shared Sub loadAllRecords(ByRef dictionary As Dictionary(Of String, category),
